    ...
    <div className="career-container">
      ...
      <div className="career-properties">
        ...
        <div className="career-text-width">
          <p className="c-properties-3">
            Being a landlord is great! Until you need to find a new tenant or
            deal with a faulty AC on your own.
          </p>
          <p className="c-properties-3">
            We’ll take care of it. From marketing your home and collecting rent
            to carrying out maintenance – and everything in between – our
