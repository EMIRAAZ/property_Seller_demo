    ...
    <div className="details-container">
      ...
      <div>
        ...
        <BasicButton
          ...
          onClick={() =>
            window.open(
              `https://wa.me/?text=Hello, I found this Property on UAE Assistant please check it out and tell me how do you feel. http://uaeassistant.com/property/${property.id}
                `,
              '_blank'
            )
          }
      ...
      <div className="details-div">
        ...
        <div className="btn-div">
          ...
          <BasicButton
            onClick={() =>
              window.open(
                `https://wa.me/+971521278701/?text=Hello UAE Assistant. I’m interested in this property http://uaeassistant.com/property/${property.id}
