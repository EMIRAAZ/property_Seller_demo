...
export default function SingleImageUpload(props) {
  ...
  const renderImage = () => (
    <div className="relative ">
      <svg
        ...
        onClick={() => onRemoveImage(props.value)}
        id="Layer_1"
        data-name="Layer 1"
        width="15.5px"
        height="15.5px"
  ...
  return (
    <div className={`flex flex-col`}>
      ...
      <div class="flex bg-gray-50 flex-col items-center border cursor-pointer justify-center  pt-2 pb-2 w-full rounded-lg">
        <div class="flex w-full justify-center">
          {props.value ? renderImage() : ''}
        </div>
        <label className="mt-6 flex justify-center" for={id}>
          <svg
            aria-hidden="true"
