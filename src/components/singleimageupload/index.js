  ...
  return (
    <div className={`flex flex-col`}>
      <label for={id}>
        ...
        <div class="flex bg-gray-50 flex-col items-center border justify-center  pt-2 pb-2 w-full rounded-lg">
          <div class="flex w-full justify-center">
            {props.value ? renderImage() : ''}
          </div>
          <label
            className="mt-6 flex justify-center cursor-pointer w-full "
            for={id}
          >
            <svg
              aria-hidden="true"
